...
@traceable(name = "check_vector_store_existence")
...
@traceable(name = "fetch_video_data", tage = ['youtube_transcript'], metadata={"api": "YouTubeTranscriptApi"})
...
@traceable(name = "create_chunks", tags = ['chunking'], metadata={"chunking_stategy": "semantic_chunking"})
...
@traceable(name = "generate_embeddings", tags = ['embeddings', "open-ai"], metadata={'embedding_model': "text-embedding-3-large"})
...
@traceable(name = "build_vector_store", tags = ['vector_store', 'embeddings'], metadata={"vector_store": "faiss"})
...
@traceable(name = "search_vector_store", metadata={"search": "semantic_search"})
...
@traceable(name = "generate_llm_response", tags= ['llm_response'], metadata={'llm_model': "gpt-4o-mini"})
